<template>
  ...
  <nav class="bg-white shadow sticky top-0 z-50">
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
      ...
      <router-link to="/" class="flex items-center space-x-2">
        ...
        <span class="font-bold text-gray-800">Mizan Amanah</span>
      </router-link>

      <!-- Menu -->
      <div class="flex space-x-6">
        <router-link to="/" class="text-gray-700 hover:text-[#FB8603] transition">Home</router-link>
        <router-link to="/tentang" class="text-gray-700 hover:text-[#FB8603] transition">Tentang</router-link>
        <router-link to="/kontak" class="text-gray-700 hover:text-[#FB8603] transition">Kontak</router-link>
      </div>
    </div>
  </nav>

  <!-- Header -->
  <header class="bg-primary text-white py-4 sticky top-0 z-40 shadow">
  ...
  <!-- Footer -->
  <footer class="bg-[#FB8603] text-white mt-12 py-6">
    <div class="container mx-auto px-4 text-center">
      <p class="text-sm">&copy; {{ new Date().getFullYear() }} Mizan Amanah. All rights reserved.</p>
